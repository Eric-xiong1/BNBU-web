...
window.MOCK = {
  ...
  evidence: {
    s1: [
      { id: "e1-1", date: "2026-07-06", time: "07:32", durationHours: 1, type: "photo", desc: "晨跑 3km", thumb: "跑步", reviewStatus: "approved" },
      { id: "e1-2", date: "2026-07-05", time: "07:28", durationHours: 1, type: "photo", desc: "晨跑 3km", thumb: "跑步", reviewStatus: "approved" },
      { id: "e1-3", date: "2026-07-04", time: "19:10", durationHours: 1.5, type: "photo", desc: "健身房力量训练", thumb: "健身", reviewStatus: "approved" },
      { id: "e1-4", date: "2026-07-03", time: "06:50", durationHours: 0.5, type: "video", desc: "跳绳 15 分钟", thumb: "跳绳", reviewStatus: "approved" },
    ],
    s2: [
      { id: "e2-1", date: "2026-07-06", time: "20:10", durationHours: 1.5, type: "photo", desc: "游泳练习", thumb: "游泳", reviewStatus: "pending" },
      { id: "e2-2", date: "2026-07-04", time: "18:00", durationHours: 1, type: "photo", desc: "游泳 800m", thumb: "游泳", reviewStatus: "approved" },
    ],
    s5: [
      { id: "e5-1", date: "2026-07-06", time: "18:15", durationHours: 2, type: "photo", desc: "篮球训练", thumb: "篮球", reviewStatus: "approved" },
      { id: "e5-2", date: "2026-07-04", time: "18:00", durationHours: 1.5, type: "photo", desc: "篮球训练", thumb: "篮球", reviewStatus: "approved" },
    ],
    s6: [
      { id: "e6-1", date: "2026-07-06", time: "06:45", durationHours: 1, type: "photo", desc: "游泳 1km", thumb: "游泳", reviewStatus: "approved" },
      { id: "e6-2", date: "2026-07-03", time: "07:00", durationHours: 1, type: "photo", desc: "游泳 800m", thumb: "游泳", reviewStatus: "approved" },
    ],
    s8: [
      { id: "e8-1", date: "2026-07-06", time: "17:30", durationHours: 1.5, type: "photo", desc: "羽毛球训练", thumb: "羽毛球", reviewStatus: "approved" },
      { id: "e8-2", date: "2026-07-05", time: "17:45", durationHours: 2, type: "video", desc: "单打对抗", thumb: "羽毛球", reviewStatus: "approved" },
    ],
    s9: [{ id: "e9-1", date: "2026-07-06", time: "16:00", durationHours: 2, type: "photo", desc: "队内训练", thumb: "篮球", reviewStatus: "approved", isSpecialty: true }],
    s11: [{ id: "e11-1", date: "2026-07-06", time: "06:58", durationHours: 1, type: "photo", desc: "校园骑行 5km", thumb: "骑行", reviewStatus: "approved" }],
    s12: [{ id: "e12-1", date: "2026-07-06", time: "19:20", durationHours: 1.5, type: "video", desc: "器械训练 45min", thumb: "健身", reviewStatus: "approved" }],
    s13: [{ id: "e13-1", date: "2026-07-06", time: "19:45", durationHours: 1, type: "photo", desc: "羽毛球练习", thumb: "羽毛球", reviewStatus: "pending" }],
    s14: [{ id: "e14-1", date: "2026-07-06", time: "07:05", durationHours: 0.5, type: "photo", desc: "操场慢跑", thumb: "跑步", reviewStatus: "approved" }],
    s15: [{ id: "e15-1", date: "2026-07-06", time: "17:40", durationHours: 1, type: "photo", desc: "瑜伽练习", thumb: "瑜伽", reviewStatus: "approved" }],
    s19: [{ id: "e19-1", date: "2026-07-06", time: "18:50", durationHours: 2, type: "photo", desc: "排球训练", thumb: "排球", reviewStatus: "approved" }],
    s21: [{ id: "e21-1", date: "2026-07-06", time: "07:22", durationHours: 1, type: "photo", desc: "晨跑 2km", thumb: "跑步", reviewStatus: "approved" }],
    s26: [{ id: "e26-1", date: "2026-07-06", time: "19:30", durationHours: 1.5, type: "photo", desc: "投篮练习", thumb: "篮球", reviewStatus: "approved" }],
    s37: [
      { id: "e37-1", date: "2026-07-06", time: "15:30", durationHours: 2, type: "video", desc: "战术演练", thumb: "篮球", reviewStatus: "approved", isSpecialty: true },
      { id: "e37-2", date: "2026-07-05", time: "16:00", durationHours: 2, type: "photo", desc: "分组对抗", thumb: "篮球", reviewStatus: "approved", isSpecialty: true },
    ],
    s43: [{ id: "e43-1", date: "2026-07-06", time: "07:15", durationHours: 1, type: "photo", desc: "早操排练", thumb: "健美操", reviewStatus: "approved", isSpecialty: true }],
    s16: [
      { id: "e16-1", date: "2026-07-06", time: "07:18", durationHours: 1, type: "photo", desc: "晨跑", thumb: "跑步", reviewStatus: "approved" },
      { id: "e16-2", date: "2026-07-04", time: "07:25", durationHours: 1, type: "photo", desc: "晨跑 2.5km", thumb: "跑步", reviewStatus: "approved" },
    ],
    s24: [{ id: "e24-1", date: "2026-07-06", time: "06:40", durationHours: 0.5, type: "video", desc: "跳绳 20min", thumb: "跳绳", reviewStatus: "approved" }],
    s31: [
      { id: "e31-1", date: "2026-07-06", time: "06:55", durationHours: 1.5, type: "photo", desc: "骑行打卡", thumb: "骑行", reviewStatus: "approved" },
      { id: "e31-2", date: "2026-07-05", time: "18:10", durationHours: 2, type: "photo", desc: "夜骑 8km", thumb: "骑行", reviewStatus: "approved" },
    ],
    s35: [{ id: "e35-1", date: "2026-07-06", time: "19:00", durationHours: 1, type: "photo", desc: "游泳 800m", thumb: "游泳", reviewStatus: "approved" }],
    s40: [{ id: "e40-1", date: "2026-07-06", time: "16:10", durationHours: 2, type: "video", desc: "内线训练", thumb: "篮球", reviewStatus: "approved", isSpecialty: true }],
    s44: [
      { id: "e44-1", date: "2026-07-06", time: "18:30", durationHours: 1.5, type: "photo", desc: "套路练习", thumb: "健美操", reviewStatus: "pending", isSpecialty: true },
      { id: "e44-2", date: "2026-07-03", time: "18:45", durationHours: 2, type: "video", desc: "完整套路录制", thumb: "健美操", reviewStatus: "approved", isSpecialty: true },
    ],
    s7: [{ id: "e7-1", date: "2026-07-06", time: "21:00", durationHours: 1, type: "photo", desc: "夜跑 3km", thumb: "跑步", reviewStatus: "pending" }],
    s10: [],
  },
  ...
  settingsHistory: [
    { at: "2026-07-06 10:20", by: "张老师", change: "体育（一）2401 学期打卡要求 18h → 20h" },
    { at: "2026-07-01 14:30", by: "张老师", change: "篮球专项 专项时长要求 4h → 5h" },
    { at: "2026-06-28 09:15", by: "张老师", change: "篮球专项A组 开启 GPS 验证（500m）" },
    { at: "2026-06-25 16:40", by: "张老师", change: "体育（二）2401 关闭 GPS 验证" },
    { at: "2026-06-20 11:00", by: "李主任", change: "全局打卡开始时间 06:30 → 06:00" },
  ],
