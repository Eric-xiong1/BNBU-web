...
export function renderProfile(state) {
  ...
  return `<section class="page-stack profile-page"><header><span class="eyebrow">PROFILE</span><h1 class="page-heading">我的</h1><p class="page-caption">身份、课程联系、组织认证与学生服务</p></header>
    ...
    <section class="menu-card"><button data-action="open-notifications"><span><b>通知</b><small>${(state.notifications || []).filter((item) => item.isUnread).length} 条未读</small></span><strong>→</strong></button><button data-route="endurance"><span><b>耐力跑成绩换算</b><small>800m / 1000m 国家标准</small></span><strong>→</strong></button><button data-route="exemptions"><span><b>免测与免打卡</b><small>免测申请、补交材料与审核记录</small></span><strong>→</strong></button><button data-route="privacy"><span><b>隐私政策</b><small>了解体育数据的采集与使用</small></span><strong>→</strong></button></section>
