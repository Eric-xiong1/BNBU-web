...
export const PROOF_IMAGE_MAX_BYTES = 10_485_760;
export const PROOF_VIDEO_MAX_BYTES = 536_870_912;
...
export function validateProofFile(file, kind, facts = {}) {
  ...
  const maxBytes = kind === "video" ? PROOF_VIDEO_MAX_BYTES : PROOF_IMAGE_MAX_BYTES;
